...
```sh
gc cli2 pack add <source-or-name> [--name <import-name>] [--version <constraint>] [--pack <path>] [--rig <name-or-path>]
```
...
- `--version` records a version constraint for registry-backed adds
